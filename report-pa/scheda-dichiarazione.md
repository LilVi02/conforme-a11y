# Scheda preparatoria — Dichiarazione di Accessibilità
...
- **Sito/servizio:** https://www.inps.it/
- **Data dell'analisi:** 19/09/2026
- **Pagine analizzate:** 3
...
### A. Legge Stanca (L. 4/2004, estesa dal D.L. 76/2020)

**Chi:** Pubbliche amministrazioni, società a controllo pubblico e operatori privati con fatturato medio superiore a 500 milioni di euro nell'ultimo triennio.
...
> dichiarazione va compilata su https://form.agid.gov.it e nient'altro vale.

### B. European Accessibility Act (Direttiva UE 2019/882, D.Lgs. 82/2022)

**Chi:** Imprese che offrono al pubblico prodotti e servizi digitali, con l'esclusione delle microimprese (meno di 10 dipendenti e fatturato annuo inferiore a 2 milioni di euro). Applicabile dal 28 giugno 2025.
...
**Scadenza:** Obblighi in vigore dal 28 giugno 2025 per i nuovi prodotti e servizi; periodo transitorio fino al 28 giugno 2030 per quelli preesistenti.
...
- **Sito o servizio oggetto della dichiarazione:** https://www.inps.it/
...
Indicazione ricavata dai soli controlli automatici: **non conforme**
...
- **Attributi ARIA non ammessi sul ruolo usato** (criterio 4.1.2 — Nome, ruolo, valore) — riscontrato su 1 pagina/e.
...
- **Lingua della pagina non dichiarata** (criterio 3.1.1 — Lingua della pagina) — riscontrato su 1 pagina/e.
  - Motivo: [ ] non conformità · [ ] onere sproporzionato · [ ] contenuto di terzi
  - Alternativa accessibile disponibile: [descrivere, oppure "nessuna"]
  - Intervento previsto entro: [data]
...
- Analisi automatica con axe-core su 3 pagina/e, in data 19/09/2026
...
- [ ] Se soggetti Legge Stanca: compilato il modello su https://form.agid.gov.it
- [ ] Fatto rivedere il testo a chi se ne assume la responsabilità

---

*Scheda generata il 19/09/2026 con Conforme. Questa sintesi ha scopo orientativo e non è consulenza legale. Il perimetro di applicazione va verificato caso per caso, anche rispetto agli aggiornamenti successivi alla stesura.*
